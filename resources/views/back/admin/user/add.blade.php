...
@section('content')
    ...
    <div class="content">
        ...
        <!-- Contact Forms -->
        <h2 class="content-heading">User Add</h2>
                    ...
                    <div class="block-content">
                        ...
                        <form method="POST" action="{{ url('/admin/user/store/') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="example-text-input1" name="name" placeholder="Please Enter your name" required>
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="example-email-input2">Email</label>
                                <input type="email" class="form-control" id="example-email-input2" name="email" placeholder="Please Enter your Email" required>
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="example-text-input3">Phone</label>
                                <input type="number" class="form-control" id="example-text-input3" name="phone" placeholder="Please Enter your Phone Number" required>
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="example-text-input4">Student ID / Employee ID</label>
                                <input type="text" class="form-control" id="example-text-input4" name="student_id" placeholder="Please Enter your ID" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="example-text-input6" name="designation" placeholder="Please Enter your Designation">
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="example-text-input7">Age</label>
                                <input type="number" class="form-control" id="example-text-input7" name="age" placeholder="Please Enter your Phone Number">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="example-textarea-input8" name="present_address" rows="4" placeholder="Present address"></textarea>
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="example-textarea-input9">Permanent Address</label>
                                <textarea class="form-control" id="example-textarea-input9" name="permanent_address" rows="4" placeholder="Permanent address"></textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="example-textarea-input11" name="short_bio" rows="4" placeholder="Short bio"></textarea>
                            </div>

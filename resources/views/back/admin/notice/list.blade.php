...
@section('content')
    ...
    <div class="content">
        <h2 class="content-heading">{{ auth()->user()->name }}  Notice</h2>
            ...
            <div class="block-content block-content-full">
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                    ...
                    <tr>
                        ...
                        <td class="fw-semibold">
                            {{ \Carbon\Carbon::parse($lists->date)->isoFormat('MMM')}}
                            {{ \Carbon\Carbon::parse($lists->date)->isoFormat('DD')}},
                            {{ \Carbon\Carbon::parse($lists->date)->isoFormat('YYYY')}}
                        </td>
                        <td class="d-none d-sm-table-cell">

                            @if($lists->status == '1')
                                <a href="{{ url('/admin/notice/status/'.$lists->id) }}">
                        ...
                        <td class="text-center">
                            <a href="{{ asset($lists->file) }}">
                                <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="tooltip" title="View">
                                    <i class="fa fa-clone" aria-hidden="true"></i>
                                </button>
                            </a>

                            <a href="{{ url('/admin/notice/delete/'.$lists->id) }}">

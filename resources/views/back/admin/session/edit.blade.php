...
@section('content')
    ...
    <div class="content">
        ...
        <div class="block block-rounded">
                        ...
                        <div class="col-md-12">
                            <div class="row mb-4">
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-control form-control-lg" style="background-color: yellow">{{ $schidules->time_slot }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="block-content">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-12">
                                <div class="col-12">
                                    <label class="form-control form-control-lg" style="background-color: yellow; text-align: center" >
                                        The Treatment Already Complete
                                    </label>
                                </div>
            ...
            @endif
            <div class="block-content">
                <form action="{{ url('/admin/session/update/'.$case->id) }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-7">
                            <div class="row mb-4">
                                <div class="col-6">
                                    ...
                                    <label class="form-control form-control-lg">{{ $case->user->name }}</label>
                                </div>
                                <div class="col-6">
                                    <label class="form-label" for="mega-lastname">Email</label>
                                    <label class="form-control form-control-lg">{{ $case->user->email }}</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="mb-4">
                                ...
                                <label type="text" class="form-control form-control-lg">{{ $case->user->phone }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-7">
                            <div class="row mb-4">
                                <div class="col-12">
                                    ...
                                    <label type="text" class="form-control form-control-lg">{{ $case->user->department }}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="mb-4">
                                ...
                                <label class="form-control form-control-lg">{{ $case->user->student_id }}</label>
                            </div>
                            <div class="row mb-4">
                                <div class="col-6">
                                    <label class="form-label" for="mega-age">Age</label>
                                    <label class="form-control form-control-lg">{{ $case->user->age }}</label>
                                </div>
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="mega-skills">Gender</label>
                                <label class="form-control form-control-lg">{{ $case->user->gender }}</label>
                            ...
                            <div class="mb-4">
                                ...
                                <label class="form-control form-control-lg">{{ $case->user->category }}</label>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="mb-4">
                                ...
                                <label class="form-control form-control-lg">{{ $case->user->present_address }}</label>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="mb-4">
                                <label class="form-label" for="mega-bio">Permanent Address</label>
                                <label class="form-control form-control-lg" >{{ $case->user->permanent_address }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="row mb-4">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="mega-firstname" name="r_name" value="{{ $case->r_name }}" placeholder="Referral Name..">
                                </div>
                                <div class="col-6">
                                    <label class="form-label" for="mega-lastname">Referring ID</label>
                                    <input type="text" class="form-control form-control-lg" id="mega-lastname" name="r_id" value="{{ $case->r_id }}" placeholder="Referral Email..">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="mega-username" name="r_department" value="{{ $case->r_department }}" placeholder="Referral Department..">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-7">
                            <div class="row mb-4">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="mega-firstname" name="r_designation" value="{{ $case->r_designation }}" placeholder="Referral Designation..">
                                </div>
                                <div class="col-6">
                                    <label class="form-label" for="mega-lastname">Referring Contract</label>
                                    <input type="text" class="form-control form-control-lg" id="mega-lastname" name="r_contract" value="{{ $case->r_contract }}" placeholder="Referral Contract Info..">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="mega-username" name="r_email" value="{{ $case->r_email }}" placeholder="Referral Email..">
                            </div>
                        </div>
                    </div>
        ...
        <div class="row items-push">
            <div class="col-xl-8">
                ...
                <div class="block block-rounded h-100 mb-0">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">{{ $sessions->order_by }} Session</h3>
                        <div class="block-options">
                            <button type="button" class="btn-block-option" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo">
                                <i class="si si-refresh"></i>
                            </button>
                    ...
                    <div class="block-content">
                                    ...
                                    <div class="options-container fx-item-rotate-r">
                                        ...
                                        <div class="options-overlay bg-black-50">
                                            <div class="options-overlay-content">
                                                ...
                                                <a class="btn btn-sm btn-alt-primary" target="_blank" href="{{ asset($sessions->image) }}">
                            ...
                            <div class="col-md-5">
                                <div class="mb-4">
                                    ...
                                    <label class="form-control" >{{ $case->psy->name }}</label>
                                </div>
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="mega-city">Next Appointment Date</label>
{{--                                <input type="date" class="form-control form-control-lg" >--}}
                                <label class="form-control" >{{ $sessions->sche->date }}</label>

                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="mega-skills">Next Appointment Time Slot</label>
                                <label class="form-control" >{{ $sessions->sche->time_slot }}</label>
        ...
        <div class="row items-push">
            <div class="col-xl-8">
                ...
                <div class="block block-rounded h-100 mb-0">
                    ...
                    <div class="block-content">
                        <form action="{{ url('/admin/session/store/'.$case->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="mb-4">
                                <label class="form-label" for="contact1-msg">Presenting Issues for the session</label>
                                <textarea class="form-control" name="presenting_issue" rows="5" placeholder="Enter your message.." required></textarea>
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="contact1-msg">Session Activities</label>
                                <textarea class="form-control" name="session_activities" rows="5" placeholder="Enter your message.." required></textarea>
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="contact1-msg">Take out from the session</label>
                                <textarea class="form-control" name="Take_out" rows="5" placeholder="Enter your message.." required></textarea>
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="contact1-msg">Take out from the session</label>
                            ...
                            <div class="col-md-5">
                                <div class="mb-4">
                                    ...
                                    <select class="js-select2 form-select" id="psy_id" name="psy_id" style="width: 100%;" data-placeholder="Choose one..">
                                        ...
                                        <option value="{{ $case->psy->id }}">{{ $case->psy->name }}</option>
                            ...
                            <div class="mb-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-check opacity-50 me-1"></i> Added
                                </button>
                            </div>
                        </form>
                    </div>

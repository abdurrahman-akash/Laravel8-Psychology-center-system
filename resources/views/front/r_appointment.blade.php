            ...
            <div class="row">
                ...
                <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2">
                    ...
                    <div class="sign__wrapper white-bg">
                        ...
                        <form method="POST" action="{{ url('/admin/r_appointment/store') }}" class="form">
                            @csrf

                                <div class="input-box">
                                    <label>Referral Name</label>
                                    <input type="text" name="r_name" placeholder="Enter Referral name" required />
                                </div>
                                <div class="input-box">
                                    <label>Referral ID</label>
                                    <input type="text" name="r_id" placeholder="Enter Referral ID" required />
                                </div>
                                <div class="input-box">
                                    <label>Referral Department</label>
                                    <div class="select2-box">
                                        <select  id="department" name="r_department" class="column select_bar" required>
                                            <option></option>
                                ...
                                <div class="input-box">
                                    <label>Referral Designation</label>
                                    <input type="text" name="r_designation" placeholder="Enter Referral Designation" required />
                                </div>
                                <div class="input-box">
                                    <label>Referral Contract</label>
                                    <input type="text" name="r_contract" placeholder="Enter Referral Contract" required />
                                </div>
                                <div class="input-box">
                                    <label>Referral Email</label>
                                    <input type="text" name="r_email" placeholder="Enter Referral Email" required />
                                </div>
                            ...
                            <hr>
                                ...
                                <div class="input-box address">
                                    ...
                                    <input type="date" id="r_date" name="r_a_date" placeholder="Enter street address" required />
                                </div>

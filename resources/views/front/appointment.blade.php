            ...
            <div class="row">
                ...
                <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2">
                    ...
                    <div class="sign__wrapper white-bg">
                        ...
                        <form method="POST" action="{{ url('/admin/case_sturdy/store_1') }}" class="form">
                            @csrf
                            ...
                            @guest
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="select2-box">
                                        <select  id="department" name="department" class="column select_bar">
                                            <option></option>
                            ...
                            @else
                                ...
                                @endif
                                    ...
                                    @if(empty(auth()->user()->phone && auth()->user()->age))
                                        <div class="input-box address">

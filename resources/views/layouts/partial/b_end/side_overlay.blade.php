                ...
                <ul class="nav-users">
                    <li>
                        <a href="be_pages_generic_profile.html">
                            <img class="img-avatar" src="{{ asset('b_end/assets/media/avatars/avatar6.jpg') }}" alt="">
                    ...
                    <li>
                        <a href="be_pages_generic_profile.html">
                            <img class="img-avatar" src="{{ asset('b_end/assets/media/avatars/avatar16.jpg') }}" alt="">
                            <i class="fa fa-circle text-success"></i>
                            <div>Scott Young</div>
                    ...
                    <li>
                        <a href="be_pages_generic_profile.html">
                            <img class="img-avatar" src="{{ asset('b_end/assets/media/avatars/avatar5.jpg') }}" alt="">
                    ...
                    <li>
                        <a href="be_pages_generic_profile.html">
                            <img class="img-avatar" src="{{ asset('b_end/assets/media/avatars/avatar12.jpg') }}" alt="">

    ...
    <div class="slider__active swiper-container">
        <div class="swiper-wrapper">
            <div class="slider__item swiper-slide p-relative slider__height slider__height-3 d-flex align-items-center z-index-1">
                <div class="slider__bg slider__overlay slider__overlay-3 include-bg"><img src="{{ asset('f_end/assets/img/dis.img/slider/slider-1.png') }}" alt=""></div>
                <div class="container">
                    <div class="row">
                        <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10 col-sm-10">
                            <div class="slider__content-3 p-relative z-index-1">
                                 <span data-animation="fadeInUp" data-delay=".3s">
                                    ...
                                    Psycology</span>
                                <h6 class="slider__title-3" data-animation="fadeInUp" data-delay=".6s" style="text-align: justify-all">“Creativity is allowing yourself to make mistakes. Art is knowing which ones to keep.”<br> – Scott Adams</h6>

                                <div class="slider__search mb-20" data-animation="fadeInUp" data-delay=".9s">
                                    <div class="course__enroll-btn pt-5">
                                        <a href="appointment.html" class="tp-btn-5 tp-btn-11">Appointment</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row align-items-end">
            <div class="col-xxl-5 col-xl-5">
                <div class="section__title-wrapper mb-60">
                    <span class="section__title-pre-3">Services</span>
                    <h2 class="section__title-2">We offer for students</h2>
                </div>
            </div>
            <div class="col-xxl-7 col-xl-7">
                <div class="category__wrapper-3 mb-60 d-sm-flex align-items-end justify-content-between">
                    ...
                    <div class="category__more mb-10">
                        <a href="services.html" class="tp-btn-5 tp-btn-8">All Services</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                <div class="category__item-3 fix transition-3 white-bg mb-30">
                    <h3 class="category__title-3"> Individual Counseling </h3>
                    <div class="category__list">
                        <ul>
                            <li><a href="services.html">One to One Counseling <i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">confidential environment<i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">Express feelings<i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">comfortable discussing<i class="fa-regular fa-arrow-right"></i></a></li>
                        </ul>
                    </div>
                    <div class="category__btn-3">
                        <a href="services.html" class="tp-btn-9 w-100">Explore</a>
                    </div>
                </div>
            </div>
            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                <div class="category__item-3 fix transition-3 white-bg mb-30">
                    <h3 class="category__title-3"> Group counseling </h3>
                    <div class="category__list">
                        <ul>
                            <li><a href="services.html">Personal Growth <i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">Supportive-Environment<i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">Interact with others<i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">Increase understanding<i class="fa-regular fa-arrow-right"></i></a></li>
                        </ul>
                    </div>
                    <div class="category__btn-3">
                        <a href="services.html" class="tp-btn-9 w-100">Explore</a>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                <div class="category__item-3 fix transition-3 white-bg mb-30">
                    <h3 class="category__title-3">Pair counseling</h3>
                    <div class="category__list">
                        <ul>
                            <li><a href="services.html">Improve their ongoing<i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">Supportive-Enviroment<i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">Helps the partner <i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">Assist people<i class="fa-regular fa-arrow-right"></i></a></li>
                        </ul>
                    </div>
                    <div class="category__btn-3">
                        <a href="services.html" class="tp-btn-9 w-100">Explore</a>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                <div class="category__item-3 fix transition-3 white-bg mb-30">
                    <h3 class="category__title-3">Family Counseling</h3>
                    <div class="category__list">
                        <ul>
                            <li><a href="services.html">Improve & Personal Growth<i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">Supportive & Confidential<i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">Interactions with Family<i class="fa-regular fa-arrow-right"></i></a></li>
                            <li><a href="services.html">Unique social system <i class="fa-regular fa-arrow-right"></i></a></li>
                        </ul>
                    </div>
                    <div class="category__btn-3">
                        <a href="services.html" class="tp-btn-9 w-100">Explore</a>
...
<!-- about-psycology area start -->
{{--    @include('layouts.partial.f_end.about_psychology')--}}
<!-- about-psycology area end -->

<!-- resources area start -->
{{--    @include('layouts.partial.f_end.resources')--}}
<!-- resources area end -->

<!-- about-psycologiest area start -->
<section class="research__area research__border grey-bg-3 pt-115 pb-90 p-relative z-index-1">
    <div class="research__shape">
        <img class="research__shape-1 d-none d-sm-block" src="{{ asset('f_end/assets/img/research/research-shape-1.png') }}" alt="">
        <img class="research__shape-2 d-none d-sm-block" src="{{ asset('f_end/assets/img/research/research-shape-2.png') }}" alt="">
        <img class="research__shape-3" src="{{ asset('f_end/assets/img/research/research-shape-3.png') }}" alt="">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xxl-12">
                <div class="section__title-wrapper mb-50 text-center">
                    <span class="section__title-pre-3">About Psycologist</span>
                    <h2 class="section__title section__title-44">Meet the Psychologist</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div class="research__item research__item-border text-center mb-30 transition-3">
                    <div class="research__thumb mb-35">
                        <img src="{{ asset('f_end/assets/img/dis.img/psycologist/psycologist_1.jpeg') }}" alt="">
                    </div>
                    <div class="research__content">
                        <h3 class="research__title">
                            Bilkis Khanam</h3>
                        <p>Psychologist <br>Daffodil International University</p>
                        <div class="course__enroll-btn pt-5">
                            <a href="appointment.html" class="tp-btn-5 tp-btn-11">Get Appointment</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div class="research__item research__item-border text-center mb-30 transition-3">
                    <div class="research__thumb mb-35">
                        <img src="{{ asset('f_end/assets/img/dis.img/psycologist/psycologist_2.jpg') }}" alt="">
                    </div>
                    <div class="research__content">
                        <h3 class="research__title">
                            Rakibul Hasan Sourav</h3>
                        <p>Psychologist <br>Daffodil International University</p>
                        <div class="course__enroll-btn pt-5">
                            <a href="appointment.html" class="tp-btn-5 tp-btn-11">Get Appointment</a>
                        </div>
        ...
        <div class="row">
            <div class="col-xxl-5 col-xl-5 col-lg-5">
                <div class="faq__wrapper pt-45 pr-25">
                    ...
                    <p>Join our club member community now to get free updates and also a lot of freebies are waiting for you or <a href="contact.html">Contact Us</a></p>

                    <div class="faq__btn">
                        <a href="faq.html" class="tp-btn-5 tp-btn-13">Read our full FAQ</a>
                    </div>
                </div>
            </div>
